...
#       sampsizeg2x1yes, "; Sample Size for Group 2 =", sampsizeg2)
  ...
  #    "%")
   ...
   cat("\nMarginal Frequency for X2=0 Group, X1=No: a+c =", sampsizeg1x1no)
   cat("\nMarginal Frequency for X2=0 Group, X1=Yes: b+d =", sampsizeg1x1yes)
   ...
   cat("\nCell Count C:", round(C, digits=2))
   cat("\nCell Count D:", round(D, digits=2))
   cat("\nMarginal Frequency for X2=1 Group, X1=No: A+C =", sampsizeg2x1no)
   cat("\nMarginal Frequency for X2=1 Group, X1=Yes: B+D =", sampsizeg2x1yes)
